...
export default function AndroidDownloadPage() {
  ...
  if (loading) {
    return (
      <div id="android-download-loading-wrapper" className="min-h-screen bg-[#07090e] flex items-center justify-center">
        <AgreyFlixLoader text="Initializing secure Android download console..." />
      </div>
    );
  }
  ...
  if (error || !details) {
    return (
      <div id="android-download-error-wrapper" className="min-h-screen bg-[#07090e] text-white flex flex-col items-center justify-center p-6 text-center">
  ...
  return (
    <div id="premium-android-download-page" className="min-h-screen bg-[#07090e] text-zinc-100 font-sans pb-24 overflow-x-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 pt-8">
        ...
        <div className="flex items-center justify-between border-b border-white/5 pb-5">
          ...
          <span className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] text-emerald-400 font-bold uppercase tracking-wider">
            <Smartphone className="w-3.5 h-3.5 text-emerald-400" /> Dedicated Android Portal
          </span>
        </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="bg-[#0b0e14]/65 border border-white/5 p-5 rounded-3xl backdrop-blur-md shadow-2xl space-y-5">
              <div className="relative aspect-[2/3] w-full rounded-2xl overflow-hidden bg-zinc-900/60 border border-white/15 shadow-lg">
                ...
                <div className="absolute bottom-3 left-3 bg-emerald-600 text-white font-extrabold text-[10px] px-2.5 py-1 rounded-md tracking-wider uppercase shadow">
                  Android Optimized
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                {type === 'tv' && (
                  <div className="p-3 bg-emerald-950/20 border border-emerald-500/10 rounded-xl">
                    ...
                    <span className="text-sm font-bold text-emerald-400">Season {season}, Episode {episode}</span>
                  </div>
                )}
                ...
                <div className="pt-3 border-t border-white/5 space-y-2">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-emerald-400 font-bold">Android OS</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#0b0e14]/40 border border-white/5 p-5 rounded-2xl space-y-3">
              ...
              <div className="flex gap-3 text-xs text-zinc-400">
                ...
                <div>
                  <span className="font-bold text-zinc-200 block">1DM: Torrent & Downloader</span>
                  <span className="text-[11px] text-zinc-500">High performance multi-threaded downloader app that maximizes your local cellular bandwidth.</span>
                </div>
              </div>
            </div>
          </div>

          {/* Column 2: Android Download Controls */}
          <div className="lg:col-span-8 space-y-6">
            
            <div className="bg-gradient-to-r from-emerald-950/20 to-zinc-900/30 border border-emerald-500/15 p-6 rounded-3xl">
              <span className="text-emerald-400 text-[10px] font-black uppercase tracking-widest bg-emerald-500/30 px-3 py-1 rounded-full border border-emerald-500/10">
                Ultra-Speed Mobile Ingress
              </span>
              <h2 className="text-2xl font-black text-white tracking-widest uppercase mt-4 mb-2">
                Android High-Speed Download Console
              </h2>
              <p className="text-xs text-zinc-400 leading-relaxed font-medium">
                Download movies and series on your Android phone using our multi-threaded backend stream. Integrating directly with 1DM allows you to bypass general browser bottlenecks!
              </p>
            </div>
            ...
            <div className="bg-[#0b0e14]/80 border border-white/5 p-6 rounded-3xl space-y-4">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <div className="flex items-center gap-2.5">
                  <span className="text-xs font-black px-2 py-1 rounded bg-emerald-600/10 text-emerald-400 border border-emerald-500/10 font-mono">01</span>
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-4 rounded-xl border transition-all duration-300 flex justify-between items-center ${
                        isSelected 
                          ? 'bg-emerald-950/10 border-emerald-500/50 shadow-lg shadow-emerald-950/10' 
            ...
            {/* STEP 2: DOWNLOADER APP */}
            <div className="bg-[#0b0e14]/80 border border-white/5 p-6 rounded-3xl space-y-4">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <div className="flex items-center gap-2.5">
                  <span className="text-xs font-black px-2 py-1 rounded bg-emerald-600/10 text-emerald-400 border border-emerald-500/10 font-mono">02</span>
                  <h3 className="text-sm font-extrabold text-white uppercase tracking-wider">Get 1DM App</h3>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-zinc-950/60 border border-white/5 rounded-2xl gap-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-white">1DM Download Manager</p>
                    <p className="text-[11px] text-zinc-500">Highest rated torrent and file downloader tool for Android devices on Google Play.</p>
                  </div>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
                >
            ...
            <div className="bg-[#0b0e14]/80 border border-white/5 p-6 rounded-3xl space-y-5">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <div className="flex items-center gap-2.5">
                  <span className="text-xs font-black px-2 py-1 rounded bg-emerald-600/10 text-emerald-400 border border-emerald-500/10 font-mono">03</span>
                  <h3 className="text-sm font-extrabold text-white uppercase tracking-wider">Send to 1DM Client</h3>
                </div>
              </div>
              ...
              <div className="p-4 bg-zinc-950/40 border border-white/5 rounded-2xl space-y-2">
                ...
                <code className="text-xs font-mono font-bold text-emerald-400 block break-all bg-zinc-900/80 p-2.5 rounded border border-white/5">
                  {videoFileName}
                </code>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <a
                  href={oneDmIntentUrl}
                  className="py-3.5 px-4 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white text-xs font-black uppercase tracking-wider rounded-xl transition-all shadow-lg flex items-center justify-center gap-1.5 text-center active:scale-98"
                >
                  <Smartphone className="w-4 h-4 text-emerald-200" /> Send stream to 1DM App
                </a>
              ...
              <div className="p-4 bg-zinc-950/70 border border-emerald-500/20 rounded-2xl text-xs text-zinc-400 space-y-2.5 leading-relaxed">
                <div className="flex items-center gap-2 text-emerald-300 font-extrabold uppercase tracking-wider text-[10px]">
                  <Info className="w-3.5 h-3.5" /> step-by-step Android download guide
                </div>
                <ul className="space-y-2 text-[11px] list-inside pl-1 text-zinc-300">
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 font-bold">1.</span>
                    <span>Ensure you have the free <strong className="text-white">1DM Download Manager</strong> app installed.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 font-bold">2.</span>
                    <span>Tap <strong className="text-emerald-400">Send stream to 1DM App</strong>. Android's system intent scheme will launch the downloader and populate your fields automatically.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 font-bold">3.</span>
                    <span>Verify the file title <code className="text-yellow-400 font-mono">{videoFileName}</code> inside 1DM and hit start.</span>
                  </li>
                </ul>
              </div>
            </div>
