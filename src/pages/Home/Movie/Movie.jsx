  ...
  useEffect(() => {
    ...
    const fetchMovies = async () => {
      ...
      try {
        ...
        if (!res.ok) throw new Error(`TMDB Response si sawa kwa ufuatiliaji wa movie genre: ${activeGenre}`);
        
        const data = await res.json();
        if (!data.results) {
          throw new Error("Mrejesho wa orodha ya video ulikuwa mtupu au batili kwenye orodha ya TMDB.");
        }
