                ...
                <>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <button
                      ...
                      className={`w-full sm:w-auto px-8 py-4 rounded-2xl flex items-center justify-center gap-3 font-extrabold uppercase tracking-widest text-xs transition-all shadow-xl cursor-po[...]
